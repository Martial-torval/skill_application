...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo,CompetencesRepository $repo): Response
    {
    ...
    public function competences(CompetencesRepository $repo): Response
    {
        $competences = $repo->findAll();
        return $this->render('session/session.html.twig',['competences'=>]);
    }
