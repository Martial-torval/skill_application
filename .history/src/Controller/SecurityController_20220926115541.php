...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo,CompetencesRepository $repo2, Inscription $entityInscription): Response
    {
        $examens = $repo->findAll();
        $competences = $repo2->findAll();
        $entityInscription = $entityInscription->getUser();
        return $this->render('session/session.html.twig',['examens'=>$examens,'competences'=>$competences, 'userRegistered' => $entityInscription]);
    }
