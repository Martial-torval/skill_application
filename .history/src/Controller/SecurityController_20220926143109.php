...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3, Request $request, Inscription $idInscription): Response
    {        
        $inscription = New Inscription();
        $user = $request->getUser();
        // dd($user);
        // dd($inscription);
        $idinscription->setUser($user);
        $idInscription->addIdInscription($inscription,true);
