...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3, Request $request, InscriptionRepository $userRepository): Response
    {        
