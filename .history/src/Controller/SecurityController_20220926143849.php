...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3, Request $request, InscriptionRepository $inscriptionRepository): Response
    {        
        $inscription = New Inscription();
        // dd($inscription);
        $user = $this->getUser();
        // $examen = $this->getExamens();
        $inscriptionRepository->addInscription($inscription,true);
        // dd($user);
