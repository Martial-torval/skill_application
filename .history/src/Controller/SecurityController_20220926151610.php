...
class SecurityController extends AbstractController
{
    ...
    #[Route(path: '/session/{id}', methods:['GET'])]


   #[Route('session/show{id}', name: 'show', methods:'GET')]
public function show($id, ExamensRepository $repo): Response {
   $exam = $repo->find($id);
   dd($exam);
//    dd($post);

return $this->render('post/detailPost.html.twig',['exam' => $exam]);
}
