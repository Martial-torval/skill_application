...
class SecurityController extends AbstractController
{
    ...
    public function user(): Response
    {
     ...
     #[ParamConverter('AllRegistered', class: 'SensioBlogBundle:Post')]
    public function examens(ExamensRepository $repo, CompetencesRepository $repo2, User $userEntity): Response
    {           
        
        
    // $registerToExam = $userEntity->getIdInscriptions()->toArray();
    dd($userEntity);
