...
class SecurityController extends AbstractController
{
    ...
    public function examens(ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3, User $userEntity): Response
    {           
        


    $nbrRegistered = count($repo3->findAll());
    ...
    dd($registerToExam)
        ...
        return $this->render('session/session.html.twig',['examens'=>$examens,'competences'=>$competences, 'nbrRegistered'=>$nbrRegistered]);
    }
