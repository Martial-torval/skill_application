...
class SecurityController extends AbstractController
{
    ...
    // $nbrRegistered = count($repo3->findAll());
     ...
     $user = $this->getUser();
    $currentUser = toString($user->getIdInscriptions());
    ...
    // dd($registerToExam);
        ...
        return $this->render('session/session.html.twig',['examens'=>$examens,'competences'=>$competences, 'currentUser'=>$currentUser]);
    }
