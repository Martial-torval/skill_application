...
class SecurityController extends AbstractController
{
    ...
    public function examens(Inscription $id, ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3): Response
    {           
        


    $nbrRegistereds = count($repo3->find($id));
