...
class SecurityController extends AbstractController
{
    ...
    public function examens($id, ExamensRepository $repo, CompetencesRepository $repo2): Response
    {           
...
#[Route(path: '/session', name: 'test')]
public function nbrRegistered(ExamensRepository $repo) {
    $nbrRegistereds = $repo->getExamens();
    dd($nbrRegistereds);
}
