...
class SecurityController extends AbstractController
{
    ...
    public function examens($id, ExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3, Inscription $inscription): Response
    {           
        


    // $nbrRegistereds = count($repo3->findBy(['id' => $id]));
    $examens = $inscription->getExamens();
    $in
