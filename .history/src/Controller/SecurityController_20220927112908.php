...
class SecurityController extends AbstractController
{
    ...
    public function examens($idExamensRepository $repo, CompetencesRepository $repo2, InscriptionRepository $repo3): Response
    {           
        


    $nbrRegistereds = count($repo->findById($id));
