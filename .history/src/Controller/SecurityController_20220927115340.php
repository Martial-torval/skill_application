...
class SecurityController extends AbstractController
{
    ...
    // $nbrRegistereds = $repo3->find($id);
     $user = $this->getUser();
     $currentUser = count($user->getIdInscriptions());
    dd($currentUser);
    ...
    // dd($registerToExam);
        ...
        return $this->render('session/session.html.twig',['examens'=>$examens,'competences'=>$competences, 'current_users', $currentUser]);
    }
