...
class SecurityController extends AbstractController
{
    ...
    // $nbrRegistereds = $repo3->find($id);
     $user = $this->getUser();
     $currentUsers = $user->getIdInscriptions()->count();
    dd($currentUser);
    ...
    // dd($registerToExam);
        ...
        return $this->render('session/session.html.twig',['examens'=>$examens,'competences'=>$competences, 'currentUsers'=> $currentUsers]);
    }
