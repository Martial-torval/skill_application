...
public function show($id, ExamensRepository $repo, InscriptionRepository $repo2, UserRepository $repo3) {
    // $inscription = new Inscription();
    // $user = $this->getUser();
    $userId = $repo3->find($id);
    dd($userId);
    // $examens = $repo->find($id);
    // $inscription->setUser($user)
                // ->setExamens($examens);
    // $nbrUserRegistration = $repo2->findByUser($id);
    // dd($nbrUserRegistration);
